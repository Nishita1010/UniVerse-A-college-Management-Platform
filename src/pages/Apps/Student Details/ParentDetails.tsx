        ...
        <>
            <div className="flex xl:flex-row flex-col gap-2.5">
                <div className="px-0 flex-1 ">
                    ...
                    <hr className="border-white-light dark:border-[#1b2e4b] my-6" />
                    <div className="mt-8 px-4">
                        <label htmlFor="permanentAdd" className=" mb-8 px-5 text-primary font-bold flex-1 ltr:mr-2 rtl:ml-2 w-1/4 mb-0 text-lg">
                    ...
                    <hr className="border-white-light dark:border-[#1b2e4b] my-6" />
                    <label htmlFor="permanentAdd" className=" mb-8 px-8 text-primary font-bold flex-1 ltr:mr-2 rtl:ml-2 w-1/4 mb-0 text-lg">
