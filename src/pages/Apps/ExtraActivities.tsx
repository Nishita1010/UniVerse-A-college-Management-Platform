...
//                     item.CertificatesorAchievements.toLowerCase().includes(search.toLowerCase()) ||
...
//                                 sortable: true,
//                                 render: ({ id}) => (
//                                     <NavLink to="/apps/id/preview">
//                                         <div className="text-primary  hover:font-bold font-semibold">{`${id}`}</div>
//                                     </NavLink>
//                                 ),
//                             },
//                             {
...
//                                 sortable: true,
//                                 render: ({ activity}) => (
//                                     <NavLink to="/apps/activity/preview">
//                                         <div className="  hover:font-bold font-semibold">{`${activity}`}</div>
//                                     </NavLink>
//                                 ),
//                             },
//                             {
...
//                               sortable: true,
//                               render: ({ type}) => (
//                                   <NavLink to="/apps/type/preview">
//                                       <div className="  hover:font-bold font-semibold">{`${type}`}</div>
//                                   </NavLink>
//                               ),
//                           },
//                           {
...
//                             sortable: true,
//                             render: ({ Organization}) => (
//                                 <NavLink to="/apps/Organization/preview">
//                                     <div className="  hover:font-bold font-semibold">{`${Organization}`}</div>
//                                 </NavLink>
//                             ),
//                         },
//                         {
//                           accessor: 'CertificatesorAchievements',
//                           sortable: true,
//                           render: ({ CertificatesorAchievements}) => (
//                               <NavLink to="/apps/CertificatesorAchievements/preview">
//                                   <div className="  hover:font-bold font-semibold">{`${CertificatesorAchievements}`}</div>
//                               </NavLink>
//                           ),
//                       },
