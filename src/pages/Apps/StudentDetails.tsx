                                            ...
                                            <div className=" pl-5 flex justify-between lg:flex-row flex-col">
                                                <div className=" w-full ltr:lg:px-6 rtl:lg:px-6 pb-6">
                                                    <div className="mt-4 flex gap-5  lg:flex-row flex-col">
                                                        ...
                                                        <input id="lastName" type="text" name="lastName" className="form-input flex-1" placeholder="Enter Mother's Name" />
                                                    </div>
                                            ...
                                            <div className=" pl-5 flex justify-between lg:flex-row flex-col">
                                                <div className=" w-full ltr:lg:px-6 rtl:lg:px-6 pb-6">
                                                    ...
                                                    <div className="mt-4 flex  gap-5 lg:flex-row flex-col">
                                                        ...
                                                        <input id="personalEmail" type="email" name="personalEmail" className="form-input flex-1" placeholder="Example- Aunt, Uncle, Brother etc." />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div className="mr-5">
                        ...
                        <div className="mt-4 flex lg:flex-row flex-col">
                            <div className="px-5 flex w-1/2">
                                ...
                                <input id="Street_Address" type="text" name="Street_Address" className="form-input flex-1" placeholder="Enter Account Number" />
                            </div>
                            <div className="px-5 flex w-1/2">
                                <label htmlFor="Street_Address_Line_2" className="ltr:mr-2 rtl:ml-2 w-28  mb-0">
                                    Account Holder's Name
                                </label>
                                <input id="Street_Address_Line_2" type="text" name="Street_Address_Line_2" className="form-input flex-1" placeholder="Enter Account Holder's Name" />
                            </div>
                        </div>
                        ...
                        <div className="mt-4 flex lg:flex-row flex-col">
                            <div className="px-5 flex w-1/2">
                                ...
                                <input id="state" type="text" name="state" className="form-input flex-1" placeholder="Enter IFSC Code" />
                            </div>
                            <div className="px-5 flex w-1/2">
                                <label htmlFor="state" className="ltr:mr-2 rtl:ml-2 w-28  mb-0">
                                    Name of the Bank
                                </label>
                                <input id="state" type="text" name="state" className="form-input flex-1" placeholder="Enter Name of the Bank" />
                            </div>
                        </div>
                        ...
                        <div className="mt-4 flex lg:flex-row flex-col">
                            <div className="px-5 flex w-1/2">
                                ...
                                <input id="city" type="text" name="city" className="form-input flex-1" placeholder="Enter Branch Name" />
                            </div>
                            <div className="px-5 flex w-1/2">
                                <label htmlFor="zip code" className="ltr:mr-2 rtl:ml-2 w-28  mb-0">
                                    Country
                                                ...
                                                {hasAilment && (
                                                    <div>
                                                        <label className=" ">
                                                            ...
                                                            <br />
                                                            <input type="text" value={ailmentDescription} onChange={handleDescriptionChange} />
                                                        </label>
                                                    </div>
                                                )}
                                            </form>
