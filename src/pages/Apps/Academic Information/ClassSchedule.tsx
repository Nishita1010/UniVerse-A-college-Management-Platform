    ...
    return (
        <>
            <div className="mb-4 panel flex justify-between items-center overflow-x-auto whitespace-nowrap p-3 text-primary">
                <div className="ltr:mr-3 text-primary  text-xl flex justify-between flex-wrap font-bold rtl:ml-3">Schedule</div>
                ...
                <div className="panel mb-5">
                    <div className="mb-4 flex items-center sm:flex-row flex-col sm:justify-between justify-center">
                        <div className="sm:mb-0 mb-4">
                            {/* <div className=" text-primary p-4 text-lg font-bold ltr:sm:text-left rtl:sm:text-right text-center">Schedule</div> */}
