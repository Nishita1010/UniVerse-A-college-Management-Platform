...
const Fees = () => {
    ...
    return (
        <>
            <div>
                <div className="mb-4 panel justify-between flex items-center overflow-x-auto whitespace-nowrap p-3 text-primary">
                    <div className="ltr:mr-3 text-primary  text-xl flex justify-between flex-wrap font-bold rtl:ml-3">Fees Collection</div>
                    ...
                    <div className="inline-block w-full">
                        <div className="mt-2 px-4">
                            <div className=" flex justify-between lg:flex-row flex-col">
                                <div className=" w-full ltr:lg:px-6 rtl:lg:px-6 pb-2">
                                    <div className=" flex gap-5  lg:flex-row flex-col">
                                        <label htmlFor="Firstname" className="ltr:mr-2 rtl:ml-2 w-28 mb-0">
                                            Course
                                        </label>
                                        <input id="Firstname" type="text" name="Firstname" className="form-input flex-1 " placeholder="Enter Course" />
                                        <label htmlFor="lastName" className="ltr:mr-2 rtl:ml-2 w-28 mb-0 ">
                                            Branch
                                        </label>
                                        <input id="lastName" type="text" name="lastName" className="form-input flex-1" placeholder="Enter Branch" />
                                    </div>
                                    <div className="mt-3 flex  gap-5 lg:flex-row flex-col">
                                        <label htmlFor="collegeEmail" className="ltr:mr-2 rtl:ml-2 w-28  mb-0">
                                            Session
                                        </label>
                                        <input id="collegeEmail" type="email" name="collegeEmail" className="form-input flex-1" placeholder="Enter Session" />

                                        <label htmlFor="personalEmail" className="ltr:mr-2 rtl:ml-2 w-28  mb-0">
                                            Date
                                        </label>
                                        <input id="personalEmail" type="date" name="personalEmail" className="form-input flex-1" placeholder="Enter Date" />
                                    </div>
                                    <div className="mt-3 flex gap-5  lg:flex-row flex-col">
                                        <label htmlFor="Firstname" className="ltr:mr-2 rtl:ml-2 w-28 mb-0">
                                            By Name
                        ...
                        <button className="btn btn-primary float-end gap-2" onClick={handleButtonClick}>
                            Search
                        </button>
                    </div>
                </div>
