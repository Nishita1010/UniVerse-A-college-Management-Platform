        ...
        <>
            <div>
                <div className="mb-4 panel justify-between flex items-center overflow-x-auto whitespace-nowrap p-3 text-primary">
                    <div className="ltr:mr-3 text-primary  text-xl flex justify-between flex-wrap font-bold rtl:ml-3">Search Due Fee</div>
                            ...
                            <div className=" flex justify-between lg:flex-row flex-col">
                                <div className=" w-full ltr:lg:px-6 rtl:lg:px-6 pb-4">
                                    <div className="mt-2 flex gap-5  lg:flex-row flex-col">
                                        ...
                                        <input id="lastName" type="text" name="lastName" className="form-input flex-1" placeholder="Enter Semester" />
                                    </div>
                                    ...
                                    <div className="mt-4 flex  gap-5 lg:flex-row flex-col">
                                        ...
                                        <input id="collegeEmail" type="email" name="collegeEmail" className="form-input flex-1" placeholder="Enter Section" />
