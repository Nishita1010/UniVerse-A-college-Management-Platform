...
const SearchFeePayment = () => {
    ...
    return (
        <>
            <div className=" mb-4 panel justify-between flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                <div className=" w-full ltr:lg:px-6 rtl:lg:px-6 pb-6">
                    <div className=" ltr:mr-3 text-primary text-xl flex justify-between flex-wrap font-bold rtl:ml-3">Search Fee Payment</div>
                    <div className="mt-4 flex gap-4 lg:flex-row flex-col">
                        <label htmlFor="Firstname" className="ltr:mr-2 rtl:ml-2 w-26 mb-0">
                            Payment ID *
                        </label>
                        <div className="w-1/3  flex-col">
                            <input id="Firstname" type="text" name="Firstname" className="form-input flex-1 " placeholder="Enter Payment ID" />
                        </div>
            ...
            {paymentID && (
                <div className="panel ">
                    <div className=" mb-4 ltr:mr-3 text-primary text-xl flex justify-between flex-wrap font-bold rtl:ml-3">Payment ID Detail</div>
